...
//             <Route path='/Add_Guest' element={<AddGuest/> } />
...
// Removed the incorrect import that was here: import { AddGuest } from './component/invitations/add-guest';
import { ProfilePage } from './component/header/ProfilePage';
// import {GuestRow} from './component/invitations/GuestRow';
// import { Add_Guest } from './component/invitations/add-guest';
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 0' }}>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/invitation-detail" element={<Invitationhome />} />
            <Route path='/invitation-GuestList' element={<GuestList />} />
            {/* Updated to use the correct component name Add_Guest */}
            {/* <Route path='/add-guest' element={<AddGuestHeader />} /> */}
            {/* <Route path='/Add_Guest' element={<Add_Guest />} /> */}
